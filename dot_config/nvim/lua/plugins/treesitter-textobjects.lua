return {
	...
	config = function()
		...
		utils.map({ "x", "o" }, "af", function()
			ts_select.select_textobject("@call.outer", "textobjects")
		end)
		utils.map({ "x", "o" }, "if", function()
		...
		utils.map({ "n", "x", "o" }, "]c", function()
			ts_move.goto_next_start("@class.outer", "textobjects")
		end)
		utils.map({ "n", "x", "o" }, "]l", function()
			ts_move.goto_next_start("@loop.outer", "textobjects")
		end)
		utils.map({ "n", "x", "o" }, "]t", function()
			ts_move.goto_next_start("@comment.outer", "textobjects")
		end)
		utils.map({ "n", "x", "o" }, "]t", function()
			ts_move.goto_next_start("@comment.outer", "textobjects")
		end)
		utils.map({ "n", "x", "o" }, "]i", function()
		...
		utils.map({ "n", "x", "o" }, "]T", function()
			ts_move.goto_next_end("@comment.outer", "textobjects")
		end)
		utils.map({ "n", "x", "o" }, "]I", function()
			ts_move.goto_next_end("@condtitional.outer", "textobjects")
		end)
		utils.map({ "n", "x", "o" }, "[m", function()
		...
		utils.map({ "n", "x", "o" }, "[T", function()
			ts_move.goto_previous_end("@comment.outer", "textobjects")
		end)
		utils.map({ "n", "x", "o" }, "[I", function()
